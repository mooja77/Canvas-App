...
export default function CodingDensityBar({ contentLength, codings, questions, height }: CodingDensityBarProps) {
  ...
  return (
    <div className="absolute left-0 top-0 rounded-sm bg-gray-100 dark:bg-gray-700/30" style={{ width: 8, height }}>
      {segments.map((seg) => (
        <div
          key={seg.id}
