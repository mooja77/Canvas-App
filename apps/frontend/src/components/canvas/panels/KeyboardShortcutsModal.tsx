...
import { useShortcutStore, DEFAULT_SHORTCUTS, SHORTCUT_LABELS, eventToCombo } from '../../../stores/shortcutStore';
    ...
    >
      ...
      >
                          ...
                          {isRecording ? (
                            ...
                            keys.map((key, ki) => (
                              <span key={ki} className="flex items-center">
                                {ki > 0 && (
                                  <span className="text-[8px] text-gray-300 dark:text-gray-600 mx-0.5">+</span>
                                )}
                                <kbd
                                  className={`inline-flex items-center justify-center min-w-[22px] rounded px-1.5 py-0.5 text-[10px] font-mono font-medium border border-gray-200/50 dark:border-gray-600/50 ${
                                    isCustomized
        ...
        <div className="mt-5 pt-4 border-t border-gray-100 dark:border-gray-700/50 flex items-center justify-between">
          <p className="text-[10px] text-gray-400 dark:text-gray-500">Customized shortcuts are highlighted in blue</p>
          <button
            onClick={resetAll}
