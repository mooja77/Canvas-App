    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40" onClick={onClose}>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 id="audio-upload-title" className="text-base font-semibold text-gray-800 dark:text-gray-200">
            Upload Audio for Transcription
          </h2>
        </div>

        <p id="audio-upload-description" className="mb-3 text-xs text-gray-500 dark:text-gray-400">
          Upload an audio or video file up to 25 MB to transcribe using AI. Supported formats: MP3, WAV, MP4, M4A, OGG,
          WebM, FLAC.
        </p>
