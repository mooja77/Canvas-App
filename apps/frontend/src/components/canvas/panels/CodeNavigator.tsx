...
export default function CodeNavigator({ onFocusNode }: CodeNavigatorProps) {
  ...
  return (
    <div data-tour="canvas-navigator" className="sidebar-slide-in flex h-full min-w-[15rem] flex-col border-r border-gray-200/80 bg-white/95 backdrop-blur-md dark:border-gray-700/80 dark:bg-gray-800/95">
      {/* Tab switcher */}
