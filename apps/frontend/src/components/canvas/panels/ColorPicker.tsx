...
export default function ColorPicker({ color, onChange, onClose }: ColorPickerProps) {
  ...
  return (
    <div
      ref={ref}
      className="popover-enter rounded-xl bg-white dark:bg-gray-800 p-2.5 shadow-lg border border-gray-200 dark:border-gray-700 w-[180px]"
    >
      <p className="text-[9px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-2 px-0.5">
        Code color
      </p>
