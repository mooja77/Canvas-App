  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="codebook-export-title"
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700">
          <div className="flex items-center gap-1">
            {/* The tabs double as the visible "title" — the heading is sr-only so the
                dialog still satisfies aria-labelledby without crowding the header row. */}
            <h2 id="codebook-export-title" className="sr-only">
              Codebook & coded data export
            </h2>
            {/* Tabs */}
            <button
            ...
            >
              All Coded Data
              <span className="ml-1.5 rounded-full bg-gray-200 dark:bg-gray-600 px-1.5 py-0.5 text-[10px] tabular-nums">
                {dataRows.length}
              </span>
            </button>
          </div>
                ...
                {dataRows.length === 0 ? (
                  ...
                  dataRows.map((row, i) => (
                    <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-750">
                      ...
                      <td className="px-3 py-2 text-gray-600 dark:text-gray-400 max-w-[250px] truncate italic">
                        &ldquo;{row.codedText}&rdquo;
                      </td>
