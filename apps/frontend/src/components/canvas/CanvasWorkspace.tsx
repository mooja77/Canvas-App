    ...
    if (isNewCanvas) {
      ...
      setNodes((currentNodes: Node[]) => {
        ...
        return freshNodes.map((n) => {
          ...
          // rebuilds. buildNodes() returns fresh objects with no size
          // info, and dropping `measured` makes getNodeDimensions() report
          // 0×0 — which leaves <MiniMap> unable to draw nodes (it renders
