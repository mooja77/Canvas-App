...
export default function ForgotPasswordPage() {
  usePageMeta(
    'Forgot Password — QualCanvas',
    'Reset your QualCanvas password. Enter your email to receive a password reset link.',
  );
        ...
        <div className="bg-white/95 dark:bg-gray-800/95 rounded-2xl shadow-xl backdrop-blur-sm p-8 ring-1 ring-gray-200/50 dark:ring-gray-700/50">
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <Link
                to="/login"
                className="inline-block text-sm text-brand-600 dark:text-brand-400 hover:underline font-medium"
              >
                Back to Sign In
              </Link>
            </div>
