    ...
    <PageShell>
      <div className="max-w-5xl mx-auto px-4 py-16 pt-10">
        ...
        <div className="mt-16">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th scope="col" className="text-left py-3 px-4 text-gray-600 dark:text-gray-400 font-medium">
                    Feature
                  </th>
                  <th scope="col" className="text-center py-3 px-4 text-gray-900 dark:text-white font-semibold">
                    Free
                  </th>
                  <th scope="col" className="text-center py-3 px-4 text-brand-600 dark:text-brand-400 font-semibold">
                    Pro
                  </th>
                  <th scope="col" className="text-center py-3 px-4 text-gray-900 dark:text-white font-semibold">
                    Team
          ...
          <div className="md:hidden space-y-6">
            {(
              [
                {
                  ...
                  features: {
                    Canvases: '1',
                    'Transcripts per canvas': '2',
                    'Words per transcript': '5,000',
                    Codes: '5',
                    'Auto-code': false,
                    'Analysis tools': '2 (Stats, Word Cloud)',
                    'Export formats': 'CSV',
                    'Share codes': '0',
                    'Ethics panel': false,
                    'Cases & cross-case': false,
                    'Intercoder reliability': false,
                ...
                },
                {
                  ...
                  features: {
                    Canvases: 'Unlimited',
                    'Transcripts per canvas': 'Unlimited',
                    'Words per transcript': '50,000',
                    Codes: 'Unlimited',
                    'Auto-code': true,
                    'Analysis tools': 'All 10',
                    'Export formats': 'CSV, PNG, HTML, MD',
                    'Share codes': '5',
                    'Ethics panel': true,
                    'Cases & cross-case': true,
                    'Intercoder reliability': false,
                    'Team management': false,
                    '.edu discount': '40% off',
                  },
                },
                {
                  ...
                  features: {
                    ...
                    'Analysis tools': 'All 10',
                    'Export formats': 'CSV, PNG, HTML, MD',
                    'Share codes': 'Unlimited',
                    'Ethics panel': true,
                    'Cases & cross-case': true,
                    'Intercoder reliability': true,
              ...
              <div
                key={plan.name}
                className={`rounded-xl p-4 ${plan.highlight ? 'ring-2 ring-brand-500 bg-white dark:bg-gray-800' : 'ring-1 ring-gray-200 dark:ring-gray-700 bg-white dark:bg-gray-800'}`}
              >
                <h3
                  className={`text-lg font-bold mb-3 ${plan.highlight ? 'text-brand-600 dark:text-brand-400' : 'text-gray-900 dark:text-white'}`}
                >
                  {plan.name}
                </h3>
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-gray-900 dark:text-white mb-8">{t('pricing.faq')}</h2>
          <div className="space-y-4">
            {[
              ...
              <details
                key={q}
                className="group bg-white dark:bg-gray-800 rounded-xl ring-1 ring-gray-200 dark:ring-gray-700"
              >
