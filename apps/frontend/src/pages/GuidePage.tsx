...
function Screenshot({ src, alt, caption }: { src: string; alt: string; caption?: string }) {
  return (
    <figure className="my-6">
      ...
      />
      {caption && (
        <figcaption className="mt-2 text-center text-sm text-gray-500 dark:text-gray-400 italic">{caption}</figcaption>
      )}
    </figure>
  );
}
...
const SECTIONS: GuideSection[] = [
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          QualCanvas is a visual workspace for qualitative research. Sign up for free with Google or email, then create
          your first canvas to begin coding interview data.
        </p>
        <Screenshot
          src="/guide/01-login.png"
          alt="QualCanvas login page"
          caption="Sign in with Google, email, or an access code"
        />
        <Steps
          steps={[
        ...
        />
        <Screenshot
          src="/guide/03-new-canvas-templates.png"
          alt="Canvas template picker"
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          The canvas workspace is where all your research happens. It's built on an infinite, zoomable canvas where you
          can arrange transcripts, codes, memos, and analysis nodes visually.
        </p>
        <Screenshot
          src="/guide/08-canvas-workspace.png"
          alt="Canvas workspace with data"
          caption="The canvas workspace with transcripts, codes, edges, memos, and analysis nodes"
        />
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Key Areas</h3>
        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Toolbar (top):</strong> Primary data tools (Transcript, Survey, Code, Memo) plus dropdown menus for
            AI, Tools, Export, and Analysis.
          </li>
          <li>
            <strong>Navigator (left sidebar):</strong> Shows all your codes and sources at a glance. Click any code to
            see its coded passages.
          </li>
          <li>
            <strong>Canvas (center):</strong> The infinite workspace where you drag, connect, and arrange nodes.
          </li>
          <li>
            <strong>Status bar (bottom):</strong> Shows document count, coding progress, collaboration status, and zoom
            level.
          </li>
          <li>
            <strong>Controls (bottom-left):</strong> Zoom in/out, fit view, and toggle interactivity.
          </li>
        </ul>
        <Screenshot
          src="/guide/05-toolbar.png"
          alt="Toolbar with dropdown menus"
          caption="The toolbar with AI, Tools, and Export dropdown menus"
        />
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Everything starts with your data. Import interview transcripts by pasting text, uploading CSV files, or
          dragging .txt files directly onto the canvas.
        </p>
        <Steps
          steps={[
        ...
        />
        <Screenshot
          src="/guide/06-add-transcript.png"
          alt="Adding a transcript"
          caption="Click the Transcript button to add interview data to your canvas"
        />
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Codes are the labels you use to tag themes in your data. Think of them as colored highlighters — each code
          marks a concept you want to track across interviews.
        </p>
        <Steps
          steps={[
        ...
        />
        <Screenshot
          src="/guide/12-navigator.png"
          alt="Canvas with codes in navigator"
          caption="Color-coded codes visible in the navigator sidebar with frequency bars"
        />
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Each code gets a distinct color so you can instantly see which themes appear where. You can organize codes
          into hierarchies using the Hierarchy tool in the Tools menu.
        </p>
        <ProTip>
          Use short, descriptive code names. You can always rename them later by double-clicking the code node.
        </ProTip>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Coding is the core activity — you select text in a transcript and assign it to a code. Lines automatically
          connect transcripts to codes, creating a visual network of your analysis.
        </p>
        <Steps
          steps={[
        ...
        />
        <Screenshot
          src="/guide/07-transcript-node.png"
          alt="Transcript node with text visible"
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          The Code Navigator in the left sidebar gives you a real-time overview of your codebook. It shows every code
          with a frequency bar indicating how often each code was used.
        </p>
        <Screenshot
          src="/guide/12-navigator.png"
          alt="Code navigator sidebar"
          caption="The Codes tab shows all codes sorted by frequency with color-coded bars"
        />
        <Steps
          steps={[
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          QualCanvas includes 10 analysis tools organized into three categories. Click the "Analyze" button in the
          toolbar to add analysis nodes to your canvas.
        </p>
        <Screenshot
          src="/guide/15-analyze-menu.png"
          alt="Analysis tools menu"
          caption="10 analysis types organized by category: Text, Coding, and Frameworks"
        />
        ...
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Text Search:</strong> Find patterns across transcripts with regex support.
          </li>
          <li>
            <strong>Word Cloud:</strong> Visualize word frequency across coded passages.
          </li>
          <li>
        ...
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Statistics:</strong> Code frequency, distribution, and coverage metrics.
          </li>
          <li>
            <strong>Co-occurrence:</strong> Matrix showing which codes appear together.
          </li>
          <li>
            <strong>Coding Query:</strong> Boolean AND/OR/NOT queries on your codings.
          </li>
          <li>
        ...
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Framework Matrix:</strong> Case x Question grid for structured analysis.
          </li>
          <li>
            <strong>Comparison:</strong> Compare coding patterns across transcripts.
          </li>
          <li>
            <strong>Theme Map:</strong> Visual theme proportions across your data.
          </li>
        </ul>
        <ProTip>
    ...
    content: (
      <>
        ...
        <Screenshot
          ...
          alt="AI tools dropdown"
          caption="Four AI-powered tools in the AI menu"
        />
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">AI Tools</h3>
        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Auto-Code:</strong> Scan transcripts and apply codes by keyword or regex pattern.
          </li>
          <li>
            <strong>AI Code:</strong> Get intelligent coding suggestions based on your existing codebook.
          </li>
          <li>
            <strong>AI Chat:</strong> Ask questions about your data in natural language. Get answers with citations.
          </li>
          <li>
            <strong>Summarize:</strong> Generate concise overviews of transcripts or coded passages.
          </li>
        </ul>
        <Steps
          steps={[
        ...
        />
        <ProTip>
          Try AI Chat with "What are the main themes across all interviews?" — it searches all your transcripts and
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Group transcripts into cases (e.g., by participant, site, or time period) and compare coding patterns across
          cases using the framework matrix.
        </p>
        <Steps
          steps={[
        ...
        />
        <ProTip>
          Cases are powerful for multi-site studies — compare coding patterns between different research sites or
          participant groups.
        </ProTip>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          QualCanvas includes built-in ethics and compliance tools to help you manage consent, anonymize data, and
          maintain an audit trail for your research.
        </p>
        <Steps
          steps={[
        ...
        />
        <ProTip>
          Set up ethics compliance before adding data — it's easier to track consent from the start than to
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Export your work in multiple formats for publication, sharing, or interoperability with other qualitative
          analysis tools.
        </p>
        <Screenshot
          src="/guide/18-export-dropdown.png"
          alt="Export options"
          caption="Export PNG, HTML/MD reports, QDPX export and import"
        />
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Export Formats</h3>
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>PNG Image:</strong> Save your canvas as a high-resolution image.
          </li>
          <li>
          ...
          <li>
            <strong>CSV:</strong> Export codebook, codings, or excerpts as spreadsheets.
          </li>
          <li>
            <strong>Codebook:</strong> Export your complete codebook with definitions and frequencies.
          </li>
        </ul>
        <ProTip>
          QDPX is the open standard for qualitative data exchange — use it to move projects between QualCanvas, NVivo,
          and ATLAS.ti.
        </ProTip>
      </>
    ),
    ...
    content: (
      <>
        ...
        <Screenshot
          ...
          alt="Share canvas modal"
          caption="Generate share codes so collaborators can clone and work on your canvas"
        />
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Collaboration Features</h3>
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Presence Avatars:</strong> See who's currently viewing the canvas.
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot
          src="/guide/23-command-palette.png"
          alt="Command palette"
          caption="Press Ctrl+K to open the Command Palette — search any action, code, or transcript"
        />
        ...
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300 font-mono">
          <li>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">Ctrl+K</kbd> — Command Palette
            (search any action)
          </li>
          <li>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">Ctrl+Z</kbd> — Undo
          </li>
          <li>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">Ctrl+Shift+Z</kbd> — Redo
          </li>
          <li>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">F</kbd> — Fit view (show all
            nodes)
          </li>
          <li>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">?</kbd> — Show all keyboard
            shortcuts
          </li>
          <li>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">Delete</kbd> — Delete selected
            nodes
          </li>
          <li>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">Alt+Drag</kbd> — Duplicate a
            node
          </li>
        </ul>
        <ProTip>
          Press ? on the canvas to see all shortcuts. Every shortcut can be remapped in the shortcuts modal.
        </ProTip>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          QualCanvas offers three plans: Free, Pro ($12/mo), and Team ($29/mo per seat). Upgrade anytime from the
          Pricing page or Account settings.
        </p>
        <Screenshot
          src="/guide/20-pricing.png"
          alt="Pricing plans"
          caption="Free, Pro, and Team plans with feature comparison"
        />
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Plan Comparison</h3>
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Free:</strong> 1 canvas, 2 transcripts, 5 codes, stats & word cloud only.
          </li>
          <li>
            <strong>Pro ($12/mo):</strong> Unlimited everything, all 10 analysis tools, AI features, ethics panel, 5
            share codes.
          </li>
          <li>
            <strong>Team ($29/mo):</strong> Everything Pro + unlimited shares, intercoder reliability, team management.
          </li>
        </ul>
        <ProTip>
          Academic users with a .edu email get 40% off automatically at checkout. Annual billing saves 25%.
        </ProTip>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <Screenshot
          ...
          alt="Dark mode canvas"
          caption="Full dark mode support — toggle via the moon/sun icon in the header"
        />
        <Screenshot
          src="/guide/24-mobile-canvas.png"
          alt="Mobile canvas view"
          caption="Responsive design on a 375px mobile viewport"
        />
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Accessibility Features</h3>
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <li>
            <strong>Dark Mode:</strong> Toggle via the moon icon in the header. Follows system preference on first
            visit.
          </li>
          <li>
            <strong>Responsive Layout:</strong> Toolbar collapses into dropdown menus on small screens.
          </li>
          <li>
      ...
      <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur dark:border-gray-800 dark:bg-gray-900/95">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/login?mode=register" className="btn-primary px-4 py-1.5 text-sm">
              Get Started
            </Link>
        ...
        <main className="flex-1 px-6 py-10 lg:px-12 max-w-4xl">
          ...
          <div className="mt-16 mb-8 rounded-2xl bg-gradient-to-br from-brand-50 to-blue-50 dark:from-brand-900/20 dark:to-blue-900/20 p-8 text-center border border-brand-200 dark:border-brand-800">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-5">
              Create your free account and begin analyzing qualitative data in minutes.
            </p>
            <Link to="/login?mode=register" className="btn-primary px-6 py-2.5 text-sm inline-block">
              Create Free Account
            </Link>
          </div>
        </main>
