  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/07-transcript-node.png" alt="Transcript node on canvas" caption="A transcript node showing interview text with scrollable content" />
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/09-code-nodes.png" alt="Multiple code nodes on canvas" caption="Color-coded nodes for different research themes" />
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/11-coding-edges.png" alt="Canvas with coding connections" caption="Lines connect transcripts to codes — each line is a coded passage" />
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/12-navigator.png" alt="Code navigator sidebar" caption="The navigator shows codes with frequency bars and coded passage counts" />
        <Steps steps={[
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/15-analyze-menu.png" alt="Analysis tools menu" caption="12 analysis types available from the Analyze menu" />
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/18-export-dropdown.png" alt="Export options" caption="Export dropdown with PNG, report, and QDPX options" />
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/22-collaboration.png" alt="Real-time collaboration" caption="Presence avatars and connection status in the status bar" />
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/23-command-palette.png" alt="Command palette" caption="Press Ctrl+K to search for any action" />
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/guide/25-dark-mode.png" alt="Dark mode canvas" caption="Full dark mode support for comfortable late-night coding sessions" />
