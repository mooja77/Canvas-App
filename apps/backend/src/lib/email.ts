          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 28px 0;">
                <tr>
                  <td style="border-radius: 6px; background-color: #4f46e5;">
                    <a href="${loginLink}" target="_blank" style="display: inline-block; padding: 14px 32px; color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600;">Sign In</a>
                  </td>
                </tr>
              </table>
              <p style="margin: 0 0 16px; color: #4a4a68; font-size: 14px; line-height: 1.6;">
              ...
              <p style="margin: 0 0 24px; word-break: break-all; color: #4f46e5; font-size: 13px;">${loginLink}</p>
              <hr style="border: none; border-top: 1px solid #e8e8ed; margin: 24px 0;" />
              <p style="margin: 0; color: #8e8ea0; font-size: 13px; line-height: 1.5;">
