...
async function getJwt(page: any) {
  ...
  return await page.evaluate(() => { const r = localStorage.getItem('qualcanvas-auth'); return r ? JSON.parse(r)?.state?.jwt || '' : ''; });
}
...
test.describe('Deep Canvas: Edge Cases', () => {
  ...
  test('2 - Template canvas creates 5 starter codes', async ({ page }) => {
  ...
  test('6 - Rapid page navigation no crash', async ({ page }) => {
    ...
    await page.goto('/canvas'); await page.waitForLoadState('networkidle');
    await page.goto('/pricing'); await page.waitForLoadState('networkidle');
    await page.goto('/canvas'); await page.waitForLoadState('networkidle');
    await page.goto('/guide'); await page.waitForLoadState('networkidle');
    await page.goto('/canvas'); await page.waitForLoadState('networkidle');
